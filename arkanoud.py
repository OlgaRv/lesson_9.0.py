# Арканоид — это игра, где мы двигаем платформу, ловим летающий мячик, разбиваем этим мячиком кирпичики.
...
# Движение платформы
    ...
    if keys[pygame.K_LEFT] and paddle_x > 0:  # Данная настройка не даёт платформе выйти за пределы экрана
